...
import { HeadTextInfoAboutProduct, InfoAboutProductWrapper } from '../styles'
...
const InfoAboutProduct: FC = () => {
	...
	const subcategories = useMemo(() => {
		return (
			categories.find(category => category.id === formik.values.category_id)
				?.subcategories || []
		)
	}, [formik])
	...
	return (
		<ProductsContainer>
			<InfoAboutProductWrapper>
				...
				<HeadTextInfoAboutProduct className='mt-10'>
					Информация о продукте
				</HeadTextInfoAboutProduct>
				...
				<div className={'w-[100%] flex gap-[24px] mt-5'}>
					...
					<Autocomplete
						...
						options={
							categoriesData.find(
								category => category.id === formik.values.category_id
							)?.subcategories || []
						}
				...
				<HeadTextInfoAboutProduct className={'mt-[30px]'}>
