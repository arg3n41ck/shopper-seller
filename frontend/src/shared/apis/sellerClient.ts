...
export class SellerClient {
	...
	async fetchProductDetailsSizeChoice(): Promise<any> {
		try {
			const { data } = await ApiClient.get<any>(
				'/sellers/product_details/product_details_size_choice/'
			)
			return data
		} catch (error) {
			throw error
	...
	async fetchProductDetailsChoice(): Promise<any> {
		try {
			const { data } = await ApiClient.get<any>(
				'/sellers/product_details/product_details_choice/'
			)
			return data
		} catch (error) {
			throw error
	...
	async fetchProductDetailsMaterialChoice(): Promise<any> {
		try {
			const { data } = await ApiClient.get<any>(
				'/sellers/product_details/product_details_material_choice/'
			)
			return data
		} catch (error) {
			throw error
	...
	async fetchBranches(): Promise<any> {
		try {
			const { data } = await ApiClient.get<TypeAddressData[]>(
				'/sellers/info/branches/'
			)
			return data
		} catch (error) {
			throw error
	...
	async createProductDetails(body: any): Promise<any> {
		try {
			const { data } = await ApiClient.post<any>(
				'/sellers/product_details/product_details/',
				body
			)
			return data
		} catch (error) {
	...
	async editProductDetails({ id, body }: any): Promise<any> {
		try {
			const { data } = await ApiClient.put<any>(
				`/sellers/product_details/product_details/${id}/`,
				body
			)
			return data
		} catch (error) {
	...
	async createProductPreviewSizes(body: any): Promise<any> {
		try {
			const { data } = await ApiClient.post<any>(
				'/sellers/product_previews_sizes/',
				body
			)
			return data
		} catch (error) {
	...
	async createProductPreviewImages({
		image,
		product_preview_id,
		main_image,
	}: any): Promise<any> {
